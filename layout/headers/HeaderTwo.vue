                ...
                <ul>
                  ...
                  <li v-else>
                    ...
                    <button class="profile__info-btn" type="button" data-bs-toggle="modal"
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="1.8em" height="1.8em" class="text-white mb-2"
                           viewBox="0 0 24 24">
                      ...
                      <span class="text-white"> ورود/ ثبت نام</span>
                    </button>
...
export default defineComponent({
  components: {LoginModal, Menus, CartMini, ExtraInfo, SearchPopup, OffCanvas},
  data() {
    return {
      isSticky: false,
      showSearch: false,
